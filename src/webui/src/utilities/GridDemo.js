...
<
    ...
    Alignment - Around < /h5>
    < div
    className = "p-grid p-justify-around" >
        < div
    className = "p-col-2" >
        < div
    className = "box" > 2 < /div>
    ...
    Alignment - Even < /h5>
    < div
    className = "p-grid p-justify-even" >
        < div
    className = "p-col-2" >
        < div
    className = "box" > 2 < /div>
    ...
    Alignment - Start < /h5>
    < div
    className = "p-grid p-align-start vertical-container" >
        < div
    className = "p-col" >
        < div
    className = "box" > 4 < /div>
    ...
    Alignment - End < /h5>
    < div
    className = "p-grid p-align-end vertical-container" >
        < div
    className = "p-col" >
        < div
    className = "box" > 4 < /div>
    ...
    className = "box" > 4 < /div>
        ...
        < h5 > Vertical
    Alignment - Stretch < /h5>
    < div
    className = "p-grid p-align-stretch vertical-container" >
        < div
    className = "p-col" >
        < div
    className = "box box-stretched" > 4 < /div>
        < /div>
        < div
    className = "p-col" >
        < div
    ...
    className = "p-grid vertical-container" >
        < div
    className = "p-col p-col-align-start" >
        < div
    className = "box" > 4 < /div>
        < /div>
        < div
    ...
    className = "box" > 4 < /div>
        < /div>
        < div
    className = "p-col p-col-align-end" >
        < div
    className = "box" > 4 < /div>
        < /div>
        < /div>
