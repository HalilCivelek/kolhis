...
<
    ...
    container
    using
    the < i > p - d - flex < /i> or <i>p-d-inline-flex</i > classes. < /p>
...
<
    ...
    < div
    className = "box p-d-flex p-mb-3" > Flex
    Container < /div>
    < div
    className = "box p-d-inline-flex" > Inline
    Flex
    Container < /div>
    ...
    applied
    using
    the < i > {`p-flex-{direction}`
}<
    /i> class where direction can be either of the following.</
    p >
    < ul >
    < li > row(
default)<
...
<
    ...
    appear in the
    flex
    container. < i > {`p-order-{value}`
}<
    /i> format is used where value can be a number from 0 to 6.</
    p >
...
<
    ...
    className = "p-d-flex" >
        < div
    className = "p-mr-2 p-order-3" > Item
    1 < /div>
    < div
    className = "p-mr-2 p-order-1" > Item
    2 < /div>
    < div
    className = "p-mr-2 p-order-2" > Item
    3 < /div>
    < /div>
...
<
    ...
    className = "p-d-flex" >
        < div
    className = "p-mr-2 p-order-3 p-order-md-2" > Item
    1 < /div>
    < div
    className = "p-mr-2 p-order-1 p-order-md-3" > Item
    2 < /div>
    < div
    className = "p-mr-2 p-order-2 p-order-md-1" > Item
    3 < /div>
    < /div>
...
<
    /i> and the value field can be either of the
    listed
    alternatives. < /p>
...
<
    /CodeHighlight>
    < div
    className = "p-d-flex p-flex-wrap-reverse" >
        < div
    className = "p-mr-2 p-mb-2" > Item
    1 < /div>
    < div
    ...
    /i> format with responsive alternatives. Value field accepts
    the
    options
    below. < /p>
    < ul >
...
<
    div
    className = "p-mr-2 p-as-start" > Start < /div>
        < div
    className = "p-mr-2 p-as-center" > Center < /div>
        < div
    className = "p-mr-2 p-as-end" > End < /div>
        < div
    className = "p-mr-2 p-as-stretch" > Stretch < /div>
        < /div>
    ...
    Link
    to = "/setup" > spacing
    utilities < /Link>, flexbox offers endless possibilities.</
    p >
    < h6 > Horizontal
    Spacing < /h6>
