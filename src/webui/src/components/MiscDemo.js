        ...
        <div className="p-grid misc-demo">
            ...
            <div className="p-col-12 p-lg-6">
                ...
                <div className="card">
                    ...
                    <h5>Label - Circle</h5>
                    <Avatar label="P" className="p-mr-2" size="xlarge" shape="circle"></Avatar>
                    <Avatar label="V" className="p-mr-2" size="large" style={{'backgroundColor': '#2196F3', 'color': '#ffffff'}} shape="circle"></Avatar>
                    <Avatar label="U" className="p-mr-2" style={{'backgroundColor': '#9c27b0', 'color': '#ffffff'}} shape="circle"></Avatar>
