...
export const MessagesDemo = () => {
    ...
    return (
        < div
    className = "p-grid messages-demo" >
        < div
    ...
    className = "card" >
        < h5 > Inline < /h5>
        < div
    className = "p-field p-grid p-align-start" >
        < label
    htmlFor = "username1"
    className = "p-col-fixed" > Username < /label>
        < div
    className = "p-col" >
        < InputText
    id = "username1"
...
=>
    ...
    className = "p-field p-grid" >
        < label
    htmlFor = "email"
    className = "p-col-fixed" > Email < /label>
        < div
    className = "p-col" >
        < InputText
    id = "email"
...
=>
    ...
    className = "p-field p-fluid" >
        < label
    htmlFor = "username2" > Username < /label>
        < InputText
    id = "username2"
    type = "text"
    className = "p-error"
